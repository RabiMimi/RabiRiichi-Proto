...
/**
 * @generated from protobuf message GameTilesMsg
 */
export interface GameTilesMsg {
    /**
...
// @generated message type with reflection information, may provide speed optimized methods
class GameTilesMsg$Type extends MessageType<GameTilesMsg> {
    constructor() {
        super("GameTilesMsg", [
            { no: 1, name: "tiles", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GameTileMsg }
        ]);
    }
    create(value?: PartialMessage<GameTilesMsg>): GameTilesMsg {
        const message = { tiles: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<GameTilesMsg>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GameTilesMsg): GameTilesMsg {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GameTilesMsg, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message GameTilesMsg
 */
export const GameTilesMsg = new GameTilesMsg$Type();
