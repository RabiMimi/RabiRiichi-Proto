...
// @generated from protobuf file "Events/InGame/IncreaseJunEvent.proto" (syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message IncreaseJunEventMsg
 */
...
class IncreaseJunEventMsg$Type extends MessageType<IncreaseJunEventMsg> {
    ...
    create(value?: PartialMessage<IncreaseJunEventMsg>): IncreaseJunEventMsg {
        const message = { playerId: 0, increasedJun: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<IncreaseJunEventMsg>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: IncreaseJunEventMsg): IncreaseJunEventMsg {
...
/**
 * @generated MessageType for protobuf message IncreaseJunEventMsg
 */
export const IncreaseJunEventMsg = new IncreaseJunEventMsg$Type();
