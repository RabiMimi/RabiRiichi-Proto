...
// @generated from protobuf file "Events/InGame/ApplyScoreEvent.proto" (syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message ApplyScoreEventMsg
 */
...
class ApplyScoreEventMsg$Type extends MessageType<ApplyScoreEventMsg> {
    ...
    create(value?: PartialMessage<ApplyScoreEventMsg>): ApplyScoreEventMsg {
        ...
        if (value !== undefined)
            reflectionMergePartial<ApplyScoreEventMsg>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ApplyScoreEventMsg): ApplyScoreEventMsg {
...
/**
 * @generated MessageType for protobuf message ApplyScoreEventMsg
 */
export const ApplyScoreEventMsg = new ApplyScoreEventMsg$Type();
